                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="blog-one__image">
                                ...
                                <a href="<?php echo base_url('artikel/detail/'.$row->id_post)?>"><i class="fa fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                        <div class="col-md-6 d-flex">
                            <div class="blog-two__content my-auto">
                                ...
                                <h3><a href="<?php echo base_url('artikel/detail/'.$row->id_post)?>"><?php echo $row->judul;?></a></h3>
                                <?php echo substr($row->isi,0,100);?>
                                <a href="<?php echo base_url('artikel/detail/'.$row->id_post)?>" class="blog-two__link">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar__single sidebar__category">
                        ...
                        <ul class="sidebar__category-list list-unstyled">
                            ...
                            <li><a href="<?php echo base_url('artikel/kategori/'.$row->id_kategori);?>"><?php echo $row->nama_kategori?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                            ...
                            <a href="<?php echo base_url('artikel/detail/'.$row->id_post)?>">
                                <li>
                                    <div class="sidebar__post-image">
                                        <img src="<?php echo base_url('gambar/post/'.$row->gambar)?>" alt="img-post">
                                    </div>
